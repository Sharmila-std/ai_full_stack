    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-6 md:px-12 py-8 space-y-8">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 border-b border-card-border/60 pb-6">
          ...
          <div className="bg-[#131a26] border border-card-border px-4 py-2.5 rounded-xl flex items-center space-x-2 self-start md:self-auto">
            <span className="text-xs text-muted-foreground font-medium uppercase tracking-wider">Total Directory Size:</span>
